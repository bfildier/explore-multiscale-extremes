...
if __name__ == "__main__":
    ...
    # define case study
    cs = defineCaseStudy(region,varid,mask)
    ...
    if func != 'all':
        ...
        grid.savePrecipRegridded(day0=day_i,dayf=day_f,func=func)

    else:
        
        # mean
        grid.savePrecipRegridded(day0=day_i,dayf=day_f,func='mean')
        # max
        grid.savePrecipRegridded(day0=day_i,dayf=day_f,func='max')
