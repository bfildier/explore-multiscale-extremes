...
def load_seg_tb_feng(i_t):
    path_toocan = get_filename_tb_feng(i_t) ## There is the differences
    with warnings.catch_warnings():
        warnings.simplefilter("ignore", category=xr.SerializationWarning)
        img_toocan = xr.open_dataset(path_toocan, engine='netcdf4').cloud_mask 
        # check with laurent what is mcs_mask  var in previous data set 
        # first answer  : mcs_mask c'est les MCS selon les critères de MCSMIP
    return img_toocan

dict_MCS_label_Tb_Feng= {
            "16-08-18": [
                832,
                833,
                834,
